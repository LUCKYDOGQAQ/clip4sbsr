...
class SketchDataSet(Dataset):
    def __init__(self, sketch_datadir, image_transforms) -> None:
        self.image_folder = datasets.ImageFolder(root=sketch_datadir, transform=image_transforms)

    def __getitem__(self, index):
        return self.image_folder[index]
